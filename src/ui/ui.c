...
lv_anim_t * gauge_Animation(lv_obj_t * TargetObject, int delay);
...
lv_anim_t * gauge_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_values(&PropertyAnimation_0, 6, 2350);
    ...
    lv_anim_set_values(&PropertyAnimation_1, 2350, 6);
...
void ui_init(void)
{
    ...
    ui_HeloScreen_screen_init();
    ui_MainScreen_screen_init();
    ui_ConfigScreen_screen_init();
    ui_ConfigScreen1_screen_init();
    ui____initial_actions0 = lv_obj_create(NULL);
    lv_obj_add_event_cb(ui____initial_actions0, ui_event____initial_actions0, LV_EVENT_ALL, NULL);

    lv_disp_load_scr(ui____initial_actions0);
    lv_disp_load_scr(ui_HeloScreen);
}

void ui_destroy(void)
{
    ui_HeloScreen_screen_destroy();
    ui_MainScreen_screen_destroy();
    ui_ConfigScreen_screen_destroy();
    ui_ConfigScreen1_screen_destroy();
}
